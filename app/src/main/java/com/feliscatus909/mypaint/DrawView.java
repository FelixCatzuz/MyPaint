...
import static com.feliscatus909.mypaint.MainActivity.paint_brush;
import static com.feliscatus909.mypaint.MainActivity.path;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                //создаем путь касания пользователя по экрану
                path.moveTo(x, y);
                invalidate();
                return true;
